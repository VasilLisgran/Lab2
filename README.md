...
4. Подпрограмма:   
    Подпрограмма переводит число в абсолютную форму и прибавляет к результирующему числу `sum` сумму цифр числа, умноженную на 5
### 5. Код программы
```java
...
```
### 5.Тесты
#### Тест 1: S33. Вывод: `StUvWxYzAbCdEfGhIjKlMnOpQrStUvWxY`
#### Тест 2: W11. Вывод: `WxYzAbCdEfG`
#### Тест 3: A1. Вывод: `A`
#### Тест 3: T78. Вывод: `TuVwXyZaBcDeFgHiJkLmNoPqRsTuVwXyZaBcDeFgHiJkLmNoPqRsTuVwXyZaBcDeFgHiJkLmNoPqRs`
...
#### Данные на выход
Для выходных данных используется строка, состоящая из `numbers[closestInd]`, ",",  `(closestInd+1)`
...
4.Вывод результата:
    Выводим значение найденного элемента: numbers[closestInd] + ", " + (closestInd+1)
...
#### Тест 4: `3 1000000 1000001 999999` Вывод: `1000000, 1`
